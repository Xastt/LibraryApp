...
public class BookDAO {
    ...
    /*public Book show(int id){
        return jdbcTemplate.query("SELECT book.name, book.author, book.year, person.fullName, person.year" +
                "FROM Book JOIN Person ON book.person_id = person.id WHERE id = ?",
